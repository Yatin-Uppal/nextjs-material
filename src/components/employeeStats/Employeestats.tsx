      ...
      <Table sx={{ minWidth: 550 }} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell sx={{color: "orange", fontWeight: "700"}} align="left">Name</TableCell>
            <TableCell sx={{color: "orange", fontWeight: "700"}} align="left">Salary</TableCell>
            <TableCell sx={{color: "orange", fontWeight: "700"}} align="left">Country</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map((row) => (
